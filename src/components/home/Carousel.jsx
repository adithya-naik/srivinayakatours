...
const Carousel = () => {
  const [slides] = useState([
    ...
    },
    {
      ...
      description: 'Carefully crafted tour packages for experiences that last a lifetime',
      link: '/packages',
    ...
    },
    {
      ...
      description: 'Our well-maintained fleet of luxury buses ensures a relaxing travel experience',
      link: '/about',
      cta: 'Learn About Our Fleet',
    },
  ]);
