  ...
  return (
    <>
      <div className="min-h-screen bg-blue-50">
        ...
        {/* Header */}
        <header className="text-center pt-6 md:pt-8 pb-4 px-4 md:px-6 bg-gradient-to-r from-blue-600 to-blue-400 text-white">
          <motion.h1
            initial={{ opacity: 0, y: -20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }}
          ...
          <motion.p
            ...
            animate={{ opacity: 1 }}
            transition={{ delay: 0.3, duration: 0.6 }}
            className="mt-2 text-sm md:text-base text-blue-100 max-w-2xl mx-auto"
          >
            Complete the booking process for {packageData.name} and prepare for
            an unforgettable journey.
          </motion.p>
          ...
          <div className="flex justify-center mb-8 md:mb-12">
            <div className="relative w-full max-w-3xl flex justify-between">
              ...
              {[
                ...
                >
                  <div
                    className={`w-8 h-8 md:w-12 md:h-12 rounded-full flex items-center justify-center border-2 shadow-md transition-all duration-300 ${
                      step > index + 1
                        ? "border-green-500 bg-green-500 text-white"
                        : step === index + 1
                        ? "border-blue-600 bg-blue-600 text-white"
                  ...
                  >
                    {step > index + 1 ? (
                      <CheckCircle size={16} className="md:text-lg" />
                    ) : (
                      <span className="text-xs md:text-base font-semibold">{index + 1}</span>
                    )}
                  </div>
                  <span
          ...
          <div className="flex flex-col lg:flex-row gap-6 md:gap-8 max-w-7xl mx-auto">
            ...
            <div className="w-full lg:w-2/3 order-2 lg:order-1">
              <AnimatePresence mode="wait">
                {step === 1 && (
                  ...
                  >
                    <h2 className="text-lg md:text-xl font-semibold mb-4 md:mb-6 flex items-center text-blue-700 border-b pb-3 md:pb-4">
                      <Calendar className="mr-2" size={20} /> Select Your
                      Experience
                    </h2>
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <input
                            ...
                            value={formData.date}
                            onChange={handleInputChange}
                            className="w-full px-3 md:px-4 py-2 md:py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white shadow-sm"
                          />
                        </div>
                      </div>
                      <div>
                        ...
                        <div className="flex items-center">
                          <button
                            ...
                            className="px-3 md:px-4 py-2 md:py-3 border border-gray-300 rounded-l-lg hover:bg-gray-100 focus:outline-none transition-colors text-blue-700"
                          >
                            <Minus size={16} />
                          </button>
                          <input
                            ...
                            onChange={handleInputChange}
                            min="1"
                            className="w-14 md:w-20 px-2 md:px-4 py-2 md:py-3 text-center border-t border-b border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white shadow-sm"
                          />
                          <button
                            onClick={() =>
                              setFormData({
                            ...
                            className="px-3 md:px-4 py-2 md:py-3 border border-gray-300 rounded-r-lg hover:bg-gray-100 focus:outline-none transition-colors text-blue-700"
                          >
                            <Plus size={16} />
                          </button>
                        </div>
                    ...
                    <div className="mb-6 md:mb-8">
                      <h3 className="text-base md:text-lg font-semibold mb-3 md:mb-4 text-gray-800 flex items-center border-b pb-2">
                    ...
                    <div className="flex justify-end mt-6 md:mt-8">
                      <button
                        onClick={nextStep}
                        className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 md:py-3 px-4 md:px-6 rounded-xl focus:outline-none focus:shadow-outline transition-colors text-sm md:text-base flex items-center"
                      >
                ...
                {step === 2 && (
                  ...
                  >
                    <h2 className="text-lg md:text-xl font-semibold mb-4 md:mb-6 flex items-center text-blue-700 border-b pb-3 md:pb-4">
                      <Users className="mr-2" size={20} /> Traveler Information
                    </h2>

                    {formData.travelers.map((traveler, index) => (
                      <div
                        key={index}
                        className="mb-4 md:mb-6 p-3 md:p-4 rounded-lg border border-gray-200 bg-gray-50"
                      >
                        <h4 className="text-base md:text-lg font-semibold mb-2 md:mb-3 text-gray-800">
                          Traveler {index + 1}
                        </h4>
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 md:gap-4">
                          <div className="col-span-1 sm:col-span-2 md:col-span-1">
                            ...
                            <input
                              ...
                              className="w-full px-3 md:px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white shadow-sm"
                            />
                          </div>
                          <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1 md:mb-2">
                        ...
                        {formData.travelers.length > 1 && (
                          <button
                            onClick={() => removeTraveler(index)}
                            className="mt-3 md:mt-4 bg-red-600 hover:bg-red-700 text-white font-bold py-1 md:py-2 px-3 md:px-4 rounded-lg focus:outline-none focus:shadow-outline transition-colors text-xs md:text-sm flex items-center"
                          >
                    ...
                    <button
                      onClick={addTraveler}
                      className="bg-green-600 hover:bg-green-700 text-white font-bold py-2 md:py-3 px-4 md:px-6 rounded-xl focus:outline-none focus:shadow-outline transition-colors text-sm md:text-base flex items-center"
                    >
                      <Plus size={16} className="mr-1" /> Add Traveler
                    </button>

                    <div className="flex flex-col sm:flex-row justify-between mt-6 md:mt-8 gap-3">
                      <button
                        onClick={prevStep}
                        className="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 md:py-3 px-4 md:px-6 rounded-xl focus:outline-none focus:shadow-outline transition-colors text-sm md:text-base flex items-center justify-center"
                      >
                        <ChevronLeft size={18} className="mr-1" /> Back
                      </button>
                      <button
                        onClick={nextStep}
                        className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 md:py-3 px-4 md:px-6 rounded-xl focus:outline-none focus:shadow-outline transition-colors text-sm md:text-base flex items-center justify-center"
                      >
                        Next <ChevronRight size={18} className="ml-1" />
                      </button>
                    </div>
                  ...
                  >
                    ...
                    <div className="mb-4 md:mb-6">
                      <label className="block text-sm font-medium text-gray-700 mb-2 md:mb-3 flex items-center">
                        <CreditCard className="mr-2 text-blue-600" size={16} />{" "}
                        Select Payment Method
                      </label>
                      <div className="flex flex-wrap items-center gap-4">
                        <label className="flex items-center">
                          ...
                          />
                          <span className="text-sm md:text-base">Credit Card</span>
                        </label>
                        <label className="flex items-center">
                          <input
                            type="radio"
                    ...
                    {formData.paymentMethod === "creditCard" && (
                      ...
                      >
                        <h3 className="text-base md:text-lg font-semibold mb-3 text-gray-800 flex items-center">
                          <CreditCard className="mr-2 text-blue-600" size={18} /> Card Details
                        </h3>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div className="md:col-span-2">
                            ...
                            <div className="relative">
                              <input
                                ...
                                className="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white shadow-sm"
                              />
                              <CreditCard
                                size={16}
                          ...
                          <div>
                            ...
                            <input
                              ...
                              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white shadow-sm"
                            />
                          </div>
                    ...
                    <div className="mb-6">
                      <label className="block text-sm font-medium text-gray-700 mb-2 flex items-center">
                        <FileText className="mr-2 text-blue-600" size={16} /> Special Requirements
                        (Optional)
                      </label>
                      <textarea
                        name="specialRequirements"
                        ...
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white shadow-sm resize-none"
                      ></textarea>
                    </div>
                        ...
                        <span className="ml-2 text-sm text-gray-700">
                          ...
                          <a
                            ...
                            onClick={(e) => {
                              ...
                              toast.info("Terms and conditions page will open in a new tab");
                            }}
                          >
                            Terms and Conditions
                          </a>{" "}
                          ...
                          <a
                            ...
                            onClick={(e) => {
                              ...
                              toast.info("Privacy policy page will open in a new tab");
                            }}
                          >
                            Privacy Policy
                          </a>
                    ...
                    <div className="flex flex-col sm:flex-row justify-between mt-6 gap-3">
                      ...
                      <button
                        ...
                        className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 md:py-3 px-4 md:px-6 rounded-xl focus:outline-none focus:shadow-outline transition-colors text-sm md:text-base flex items-center justify-center"
                      >
                        Complete Booking <CheckCircle size={18} className="ml-1" />
                      </button>
                    </div>
                  </motion.div>
                )}
            ...
            <div className="w-full lg:w-1/3 order-1 lg:order-2">
              <motion.div
                ...
                initial="hidden"
                animate="visible"
                className="bg-white p-4 md:p-6 rounded-xl shadow-lg sticky top-6"
              >
                <h2 className="text-lg md:text-xl font-semibold mb-4 flex items-center text-blue-700 border-b pb-3">
                  <FileText className="mr-2" size={20} /> Booking Summary
                </h2>
                ...
                <div className="mb-4">
                  ...
                  <motion.h3 variants={itemVariants} className="text-base md:text-lg font-semibold mb-1">
                    {packageData.name}
                  </motion.h3>
                  <motion.div variants={itemVariants} className="flex items-center mb-2 text-sm text-gray-600">
                ...
                <motion.div variants={itemVariants} className="mt-6 pt-4 border-t">
                  <h4 className="text-sm font-medium mb-3 text-gray-700">Price Details:</h4>
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      <span className="text-gray-600">Base Price (per person)</span>
                      <span>₹{packageData.plans[selectedPlan].discountedPrice.toLocaleString()}</span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="flex justify-between font-bold text-base pt-2 border-t border-dashed border-gray-200 mt-2">
                      ...
                      <span className="text-blue-700">
                        ₹{(calculateTotal() + Math.round(calculateTotal() * 0.18)).toLocaleString()}
                      </span>
                    </div>
                  </div>
                </motion.div>
                ...
                {/* Trust Badges */}
                <motion.div variants={itemVariants} className="mt-6 pt-4 border-t">
                  <h4 className="text-xs font-medium mb-3 text-gray-500 flex items-center">
                    <Shield className="mr-1" size={14} /> SAFE & SECURE BOOKING
                  </h4>
                  <div className="flex justify-between">
                    <div className="flex flex-col items-center text-xs text-gray-500">
                      <Shield size={20} className="mb-1 text-green-600" />
                      <span>Secure Payments</span>
                    </div>
                    <div className="flex flex-col items-center text-xs text-gray-500">
                      <Award size={20} className="mb-1 text-blue-600" />
                      <span>Best Price Guarantee</span>
                    </div>
                    <div className="flex flex-col items-center text-xs text-gray-500">
                      <Heart size={20} className="mb-1 text-red-600" />
        ...
        {/* Help Section */}
        <div className="bg-blue-50 py-8 px-4 md:px-6 mt-8">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-xl md:text-2xl font-bold mb-6 text-center text-blue-800">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white p-5 rounded-xl shadow-md flex flex-col items-center text-center">
                ...
                <p className="text-gray-600 text-sm">Our travel experts are available 24/7</p>
                <a
              ...
              <div className="bg-white p-5 rounded-xl shadow-md flex flex-col items-center text-center">
                ...
                <p className="text-gray-600 text-sm">Send us your queries anytime</p>
                <a
                  href="mailto:support@adventurehub.com"
                  className="mt-3 text-blue-600 hover:text-blue-800 font-medium"
                >
              ...
              <div className="bg-white p-5 rounded-xl shadow-md flex flex-col items-center text-center">
                <Info size={24} className="text-blue-600 mb-3" />
