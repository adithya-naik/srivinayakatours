...
const AboutPage = () => {
  ...
  // Stats section data
  const stats = [
    { icon: <Clock size={24} className="text-blue-500" />, value: "18+", label: "Years of Service" },
    { icon: <Users size={24} className="text-blue-500" />, value: "1M+", label: "Happy Passengers" },
    { icon: <MapPin size={24} className="text-blue-500" />, value: "100+", label: "Routes Covered" },
    { icon: <Award size={24} className="text-blue-500" />, value: "15+", label: "Industry Awards" }
  ];
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-20 mb-12 text-center">
            ...
            <p 
              ...
              data-aos-delay="100"
            >
              At Sri Vinayaka Travels, we are guided by our commitment to excellence,
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto" data-aos="fade-up" data-aos-delay="100">
              Don't just take our word for it - hear from our satisfied passengers about their experience traveling with us.
            </p>
          </div>
            ...
            {[
              {
                ...
                quote: "The comfort and punctuality of Sri Vinayaka Travels has made it my go-to choice for all my journeys. The staff is always courteous and helpful."
              },
              {
                name: "Priya Sharma",
                role: "Business Traveler",
                quote: "As someone who travels frequently for work, I appreciate the reliable service and comfortable buses. The online booking system is also very convenient."
              },
              {
                name: "Amit Patel",
                role: "Family Vacation",
                quote: "Our family trip was made even more enjoyable thanks to the excellent service of Sri Vinayaka Travels. Clean buses and friendly staff!"
              }
